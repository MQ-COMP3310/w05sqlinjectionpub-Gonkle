    ...
    public static void main(String[] args) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("resources/data.txt"))) {
            ...
            while ((line = br.readLine()) != null) {
                if (!line.matches("^[a-z]{4}$")) { // Validate input
                    logger.severe("Invalid word in data.txt: " + line + ". Skipping...");
                } else {
            ...
            System.out.println("An error occurred while reading the word list. Please try again.");
        }
        ...
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            while (!guess.equals("q")) {
                if (!guess.matches("^[a-z]{4}$")) { // Validate input
